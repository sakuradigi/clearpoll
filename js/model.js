...
const ClearPollModel = {
  ...
  getAIElectionAssessment(electionId, city, context = {}) {
    ...
    const assessments = {
      ...
      changhua: {
        shortBrief: '中台灣一級戰區，呈現五五波拉鋸。綠營邱建富預估得票率約 51.5% vs 魏平政 48.5%。現任王惠美卸任後，魏平政主打法律行政，邱建富深耕北彰化。',
        detailedBrief: '彰化縣向來為台灣大選『搖擺州』之首。王惠美兩屆任滿後，國民黨徵召具法律與行政歷練的魏平政出征，而民進黨由深耕地方的前彰化市長邱建富領軍。ETtoday最新民調邱建富以 38.5% 微幅超車魏平政 35.2%，選情處於極限拉鋸，勝負將由中間搖擺選民定奪。',
        factors: [
      ...
      chiayicity: {
        shortBrief: '綠營王美惠支持度領跑，預估得票率約 54.8% vs 張啓楷 45.2%。黃敏惠任滿後藍白協調由張啓楷出征，王美惠憑親民形象保持領先。',
        detailedBrief: '嘉義市被譽為『民主聖地』，政治板塊素有看人不看黨的傳統。五星級市長黃敏惠任期屆滿，民進黨立委王美惠憑藉全台最高得票率立委之親民形象強勢出戰，關鍵調查民調達 46.5%。民眾黨立委張啓楷代表在野陣營角逐，模型評估王美惠掌握領先格局。',
        factors: [
      ...
      yilan: {
        shortBrief: '綠營林國漳微幅領先，預估得票率約 54.1% vs 45.9%。林姿妙任滿後民進黨徵召林國漳全力收復民主聖地，吳宗憲法治形象鮮明，選情拉鋸。',
        detailedBrief: '宜蘭縣長選情進入政黨輪替關鍵戰。國民黨林姿妙任期屆滿，民進黨徵召具法律專業形象的林國漳出征，在農會、水利會與在地社團全面整合，民調以 39.5% 領先國民黨立委吳宗憲 32.8%（差距約 6.7%）。宜蘭歷史人文偏向民主進步黨傳統價值，模型評估林國漳具備勝選機會。',
        factors: [
          '核心勝負手：高鐵延伸宜蘭政績認同與青年返鄉投票率',
          '基本盤結構：宜蘭傳統文風昌盛，綠營基本盤略具優勢',
          '機構效應：山水民調與關鍵調查一致呈現林國漳領先'
        ],
        confidence: '優勢領先 (機會高)'
      },
      hualien: {
        shortBrief: '前花蓮市長魏嘉賢在泛藍三腳督中相對領先，預估得票率約 46.8% vs 游淑貞 39.6% vs 張峻 13.6%。後山呈現泛藍高度分裂與組織肉搏。',
        detailedBrief: '花蓮縣選情迎來歷史性泛藍大分流。徐榛蔚兩屆任滿後，國民黨提名吉安鄉長游淑貞接棒，但前花蓮市長魏嘉賢與現任縣議會議長張峻均以無黨籍完成登記，形成三強鼎立。TVBS民調魏嘉賢在花蓮市及都會選區以 42.5% 領跑，游淑貞以 35.8% 緊追，張峻獲 12.2% 議會宗親支持，模型評估魏嘉賢保有相對優勢。',
        factors: [
          '核心勝負手：花蓮市與吉安鄉等都會人口集中區投票傾向',
          '基本盤結構：後山泛藍選票高達七成，三強均瓜分藍營板塊',
          '機構效應：TVBS與菱傳媒均顯示魏嘉賢與游淑貞呈現拉鋸'
        ],
