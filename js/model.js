...
const ClearPollModel = {
  ...
  getAIElectionAssessment(electionId, city, context = {}) {
    ...
    const assessments = {
      ...
      hsinchucity: {
        shortBrief: '現任市長高虹安在三腳督中維持相對領先，預估得票率約 44.5% vs 林志潔 33.6% vs 鄭正鈐 21.9%。科技選民偏好與反綠板塊分流為關鍵。',
        detailedBrief: '新竹市呈現高張力三腳督格局。高虹安雖受停職與司法案件爭議衝擊，但在竹科園區年輕家庭與中間選民中仍保有強大辨識度與支持度，匯流民調顯示其維持 37.4% 領跑。民進黨林志潔在深綠與學者選票穩固但外溢不足，國民黨鄭正鈐受限於在野分裂，模型評估高虹安保有相對優勢。',
        factors: [
      ...
      hsinchucounty: {
        shortBrief: '全台五五波關鍵激戰區。徐欣瑩與鄭朝方預估得票率 52.1% vs 47.9%（差距約 4.2%）。竹北科技新移民湧入大幅重塑選民結構，選情高度膠著。',
        detailedBrief: '新竹縣迎來數十年來最緊繃的縣長選戰。國民黨徐欣瑩在傳統客家十三鄉鎮擁有深厚宗親與組織實力；但民進黨竹北市長鄭朝方以高滿意度市政成績，在佔全縣人口逾三分之一的竹北市形成壓倒性號召力。精確市場研究8月民調雙方僅差 3.3%，屬一級激戰區。',
        factors: [
          '核心勝負手：竹北市新興科技人口投票率 vs 傳統鄉鎮動員力',
          '基本盤結構：傳統藍營鐵票區正快速轉向中立搖擺',
          '機構效應：艾普羅(+7.4%藍) vs 聯合聚焦(+3.3%藍)'
        ],
        confidence: '膠著激戰 (機會尚可)'
      },
      miaoli: {
        shortBrief: '現任縣長鍾東錦實力雄厚掌握壓倒性優勢，預估得票率約 69.5% vs 30.5%。藍營基層與派系高度整合，陳光軒難以突破山海線結構。',
        detailedBrief: '苗栗縣選情呈現現任者全面掌控格局。鍾東錦自無黨籍當選後與國民黨中央建立緊密互信，施政滿意度長年位居全台前列，歷次民調均大幅領先民進黨對手陳光軒 30 個百分點以上。苗栗山線客家與海線閩南派系全面歸隊，模型評估鍾東錦連任毫無懸念。',
        factors: [
      ...
      changhua: {
        shortBrief: '中台灣一級戰區，呈現五五波拉鋸。民進黨陳素月預估得票率約 51.5% vs 謝衣鳯 48.5%。現任王惠美卸任後，藍綠兩大立委交鋒，南彰化與北彰化版圖割據。',
        detailedBrief: '彰化縣向來為台灣大選『搖擺州』之首。王惠美兩屆任滿後，國民黨立委謝衣鳯坐擁南彰化強大組織體系，但民進黨立委陳素月在北彰化與都會區具備強大開票爆發力。ETtoday最新民調陳素月以 38.5% 微幅超車謝衣鳯 35.2%，選情處於極限拉鋸，勝負將由中間搖擺選民定奪。',
        factors: [
          '核心勝負手：北彰化都會選民 vs 南彰化農會組織開票率',
          '基本盤結構：全台典型搖擺縣，藍綠歷年均勢',
          '機構效應：ETtoday(+3.3%綠) vs TVBS(+0.4%綠)'
        ],
        confidence: '膠著拉鋸 (五五波)'
      },
      nantou: {
        shortBrief: '現任縣長許淑華坐擁超高民意支持，預估得票率約 65.5% vs 34.5%。南投基本盤藍大於綠，蔡培慧雖具全國聲量但難撼動許淑華親民光環。',
        detailedBrief: '南投縣由現任縣長許淑華展現穩健連任姿態。許淑華以高親和力與觀光、農業政策獲得縣民極高信任度，TVBS民調支持度高達 54.2%，領先蔡培慧達 25.7 個百分點。蔡培慧雖深耕地方並有中央經歷，但在南投結構性藍大於綠的版圖下難以破局，模型評估許淑華勝選機會極高。',
        factors: [
      ...
      chiayicity: {
        shortBrief: '綠營王美惠支持度領跑，預估得票率約 50.8% vs 張啓楷 34.2% vs 鄭光宏 15.0%。黃敏惠任滿後藍營接班未定，王美惠在野分裂下勝算濃厚。',
        detailedBrief: '嘉義市被譽為『民主聖地』，政治板塊素有看人不看黨的傳統。五星級市長黃敏惠任期屆滿，民進黨立委王美惠憑藉全台最高得票率立委之親民形象強勢出戰，關鍵調查民調達 42.5%。在野陣營民眾黨張啓楷與國民黨鄭光宏票源重疊，模型評估王美惠勝選機會極高。',
        factors: [
      ...
      chiayicounty: {
        shortBrief: '綠營蔡易餘掌握壓倒性優勢，預估得票率約 64.6% vs 35.4%。現任縣長翁章梁高滿意度全面力挺，綠營嘉義農工大縣堡壘堅若磐石。',
        detailedBrief: '嘉義縣為民進黨長年執政的核心大本營。五星縣長翁章梁高滿意度交棒，由海線重量級立委蔡易餘出馬角逐，獲得山海線綠營民代與農田水利系統一致支持。國民黨詹琬蓁雖問政犀利但基層組織難以全面抗衡，模型評估蔡易餘勝選機會極高。',
        factors: [
      ...
      yilan: {
        shortBrief: '綠營陳俊宇微幅領先，預估得票率約 54.1% vs 45.9%。林姿妙任滿後民進黨全力收復民主聖地，吳宗憲法治形象鮮明但宜蘭基層由綠營搶佔先機。',
        detailedBrief: '宜蘭縣長選情進入政黨輪替拉鋸。國民黨林姿妙任期屆滿，民進黨立委陳俊宇在農會、水利會與在地社團全面整合，民調以 39.5% 領先國民黨立委吳宗憲 32.8%（差距約 6.7%）。宜蘭歷史人文偏向民主進步黨傳統價值，模型評估陳俊宇具備高勝選機會。',
        factors: [
          '核心勝負手：高鐵延伸宜蘭政績認同與青年返鄉投票率',
          '基本盤結構：宜蘭傳統文風昌盛，綠營基本盤略具優勢',
          '機構效應：山水民調與關鍵調查一致呈現陳俊宇領先'
        ],
        confidence: '優勢領先 (機會高)'
      },
      hualien: {
        shortBrief: '泛藍魏嘉賢陣營壓倒性領先，預估得票率約 69.8% vs 30.2%。後山藍營基本盤堅如磐石，Kolas Yotaka難以動搖花東縱谷結構。',
        detailedBrief: '花蓮縣選情延續藍營絕對優勢局面。徐榛蔚兩屆任滿後，前花蓮市長、縣議員魏嘉賢獲得泛藍跨黨派與基層農漁會系統全力擁護，歷次民調均維持在 56%~58% 高檔。民進黨參選人Kolas Yotaka在原住民鄉鎮雖具親和力，但整體版圖難越藍營鐵票高牆，模型評估藍營勝算極高。',
        factors: [
          '核心勝負手：花蓮市與吉安鄉等都會人口集中區投票傾向',
          '基本盤結構：花蓮長年維持藍大於綠 (約 70:30)',
          '機構效應：TVBS與菱傳媒均顯示泛藍領先超過 30%'
        ],
        confidence: '絕對優勢 (機會極高)'
      },
      taitung: {
        shortBrief: '藍營黃建賓穩定領先，預估得票率約 61.1% vs 38.9%。饒慶鈴縣府政績滿意度高，黃建賓獲縱谷與南迴全面支持，陳瑩在原鄉難以扭轉全縣大盤。',
        detailedBrief: '台東縣長選情由國民黨立委黃建賓接棒饒慶鈴。台東縣近年在慢經濟與觀光施政上滿意度居高不下，為藍營後續選戰奠定扎實底氣。民進黨立委陳瑩在平地原住民社群號召力強，但在台東市與縱谷農業區，黃建賓以超過五成支持度穩居第一，模型評估黃建賓連任勝局明朗。',
        factors: [
          '核心勝負手：台東市區中間選民與原住民返鄉票',
          '基本盤結構：台東結構藍大於綠，現任政績紅利明顯',
          '機構效應：TVBS民調黃建賓領先 19.2 個百分點'
        ],
        confidence: '絕對優勢 (機會極高)'
      },
      penghu: {
        shortBrief: '離島高度膠著五五波激戰區。陳雙全與陳光復預估得票率約 50.8% vs 49.2%（差距僅 1.6%）。現任執政包袱面對藍營團結挑戰，澎湖再現五五波拉鋸。',
        detailedBrief: '澎湖縣迎來離島最激烈的肉搏戰。民進黨現任縣長陳光復受到醫療後送與離島交通補貼等施政議題檢驗；國民黨前副議長陳雙全在地方基層耕耘數十年，軍公教與漁民票源高度凝聚。關鍵調查8月最新民調陳雙全 41.8% vs 陳光復 40.5%（差距1.3%），勝負僅在數百票之間，屬典型五五波。',
        factors: [
          '核心勝負手：台澎交通客輪與機票補貼政策感受度',
          '基本盤結構：澎湖為全台知名搖擺選區，藍綠歷屆輪替頻繁',
          '機構效應：關鍵調查(+1.3%藍) vs 山水民調(+0.2%綠)'
        ],
        confidence: '膠著激戰 (五五波)'
      },
      kinmen: {
        shortBrief: '藍營陳玉珍掌握絕對優勢，預估得票率約 60.5% vs 39.5%。陳玉珍中央高曝光度與兩岸小三通政策發揮效應，陳福海受排黑限制，金門藍天穩固。',
        detailedBrief: '金門縣長選戰由國民黨立委陳玉珍展現強大統治力。陳玉珍問政風格鮮明，積極爭取陸客赴金門旅遊與兩岸通航政策，獲得基層高度支持。現任縣長陳福海受選罷法排黑修法影響參選資格受挫，陳玉珍在TVBS民調中以 55.4% 遠勝對手 19.2 個百分點，模型評估陳玉珍勝選機會極高。',
        factors: [
      ...
      lienchiang: {
        shortBrief: '現任縣長王忠銘掌握絕對領先，預估得票率約 59.8% vs 曹爾元 32.5% vs 李問 7.7%。馬祖四鄉五島藍營政通人和，王忠銘連任勝算極高。',
        detailedBrief: '連江縣（馬祖）選情由現任縣長王忠銘展現穩定優勢。王忠銘推動馬祖新航運與機場升級工程獲地方好評，關鍵調查民調達 56.5%。前地政局長曹爾元在南竿有部分宗親票源但難撼大局，民進黨李問深耕基層但基本盤有限，模型評估王忠銘連任勝選機會極高。',
        factors: [
