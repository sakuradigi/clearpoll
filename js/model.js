...
const ClearPollModel = {
  ...
  getAIElectionAssessment(electionId, city, context = {}) {
    ...
    const assessments = {
      ...
      changhua: {
        shortBrief: '中台灣指標戰場，綠營陳素月掌握領先優勢，預估得票率約 51.8% vs 魏平政 27.6% vs 邱建富 20.6%。邱建富脫黨參選形成三腳督，國民黨魏平政受王惠美輔選力道不足影響陷入苦戰。',
        detailedBrief: '彰化縣向來為台灣大選『搖擺州』。民進黨在黨內類初選後正式提名現任立委陳素月，前市長邱建富則退黨以無黨籍登記參選引發票源分流。國民黨徵召律師魏平政，但現任縣長王惠美未全力輔選，藍營基層整合受阻。ETtoday最新民調陳素月以 36.4% 穩定領先魏平政 19.4% 與邱建富 12.7%，模型評估陳素月勝選機會高。',
        factors: [
          '核心勝負手：南彰化陳素月立委本盤 vs 北彰化邱建富瓜分綠票程度',
          '基本盤結構：縣長王惠美輔選動向與藍營基層農水會系統整合',
          '機構效應：三腳督格局下陳素月維持兩位數穩定領先優勢'
        ],
        confidence: '優勢領先 (機會高)'
      },
      nantou: {
