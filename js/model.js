...
const ClearPollModel = {
  ...
  getAIElectionAssessment(electionId, city, context = {}) {
    ...
    const assessments = {
      ...
      hualien: {
        shortBrief: '國民黨游淑貞在泛藍三腳督中暫居領先，預估得票率約 40.3% vs 魏嘉賢 31.1% vs 張峻 28.6%。傅崐萁與徐榛蔚強力輔選吉安鄉長游淑貞，魏嘉賢與張峻瓜分反傅與年輕選票。',
        detailedBrief: '花蓮縣選情迎來泛藍大對決。徐榛蔚兩屆任滿後，國民黨提名吉安鄉長游淑貞接棒，獲得傅徐體系深厚基層組織與原鄉力挺。前市長魏嘉賢在年輕族群領跑，現任議長張峻則在反傅與綠營群體獲支持。風傳媒與包打聽民調顯示游淑貞以 27-29% 支持度暫居第一，魏嘉賢與張峻各握約兩成支持，模型評估游淑貞具備組織接棒優勢。',
        factors: [
