...
const ClearPollModel = {
  ...
  getAIElectionAssessment(electionId, city, context = {}) {
    ...
    const assessments = {
      newtaipei: {
        shortBrief: '全台最具指標性五五波激戰區。李四川與蘇巧慧預估得票率約 50.6% vs 49.4%（差距僅 1.2%）。9月23日震傳媒（山水執行）民調蘇巧慧 38.2% 首度逆轉超車李四川 37.1%，此前美麗島電子報亦呈 38.2% vs 38.0% 平盤。中間選民與白營流向為勝負分水嶺。',
        detailedBrief: '新北市呈現完全均勢的五五波極限拉鋸。9月23日《震傳媒》公布由山水民意研究執行之最新民調，蘇巧慧以 38.2% 首度微幅領先李四川之 37.1%（領先 1.1 個百分點，抽樣誤差 ±2.99%），且看好度李四川 42.0% 領先蘇巧慧 36.8%。此前9月中旬美麗島電子報李四川 38.2% vs 蘇巧慧 38.0% 亦呈均勢平盤。在抗機構偏誤校正與動態時間衰減下，雙方預估得票率收斂至 50.6% vs 49.4% 的極限膠著，勝率約 69.8% vs 30.2%。蘇巧慧在年輕族群與換黨氛圍中展現反撲韌性，最後勝負關鍵在於中立選民催票率。',
        factors: [
          '核心勝負手：中間選民與首投族催票率 vs 藍營執政包袱',
          '基本盤結構：新北歷史藍綠 51:49 均勢盤',
          '機構效應：震傳媒(+1.1%綠逆轉) vs 美麗島(+0.2%藍平盤) vs 匯流(+0.8%藍)'
        ],
        confidence: '膠著五五波 (極高拉鋸)'
      },
      kaohsiung: {
        shortBrief: '綠營賴瑞隆維持領先但戰況驟然升溫，預估得票率約 52.0% vs 48.0%（差距 4.0%）。9月23日 TPOC 最新 AI 民意模擬賴瑞隆 37.8% vs 柯志恩 34.5%（看好度賴 40.1%），此前 ETtoday 呈五五波拉鋸，陳其邁執政紅利與原縣區動員為綠營防線。',
        detailedBrief: '高雄市選情由民進黨參選人賴瑞隆維持微幅優勢，但選局張力顯著升高。9月23日 TPOC 台灣議題研究中心公布 AI 民意模擬預測，賴瑞隆以 37.8% 領先柯志恩 34.5%（差距 3.3%），看好度亦以 40.1% 領先柯之 28.5%。此前 9月18日 ETtoday 民調雲柯志恩 43.8% 與賴瑞隆 43.5% 差距僅 0.3% 呈平盤。雖然傳統長期多機構民調中賴瑞隆在原縣區組織與綠營基本盤（約 56:44）佔優，且現任市長陳其邁施政滿意度破七成提供後盾，模型預估賴瑞隆以 52.0% vs 48.0% 保有勝勢，但柯志恩追擊氣勢不可小覷。',
        factors: [
          '核心勝負手：原縣區農漁會與組織動員 vs 市區中間選民移轉',
          '基本盤結構：高雄歷史基本盤綠大於藍，陳其邁執政紅利雄厚',
          '機構效應：TPOC(+3.3%綠) vs ETtoday(+0.3%藍平盤) vs 鏡新聞(+5.4%綠)'
        ],
        confidence: '微幅領先 (拉鋸升溫)'
      },
      taichung: {
        shortBrief: '藍營江啟臣維持雙位數領先，預估得票率約 58.1% vs 41.9%（差距 16.2%）。9月23日 TPOC 最新 AI 民意模擬江啟臣 44.5% 領先何欣純 32.4%，此前 TVBS 亦領先 12.6%，盧秀燕市政光環加持，江啟臣連任接棒勝算極高。',
        detailedBrief: '台中市選情呈現藍營顯著優勢局面。何欣純深耕原台中縣區基層，近期積極合體助選拉抬青年氣勢。然而現任市長盧秀燕長年穩居全台施政滿意度前列，9月23日 TPOC 台灣議題研究中心最新 AI 民意模擬顯示江啟臣以 44.5% 領先何欣純 32.4%（差距 12.1%），9月中旬 TVBS 民調江啟臣亦以 45.1% 領先何欣純 32.5%。藍營現任市政光環與地方派系整合完整，模型評估江啟臣勝選機會極高。',
        factors: [
          '核心勝負手：原縣區地方派系與中間搖擺票',
          '基本盤結構：台中搖擺性強但目前藍營執政紅利雄厚',
          '機構效應：TPOC(+12.1%藍) vs TVBS(+12.6%藍) vs 聯合聚焦(+15.3%藍)'
        ],
        confidence: '優勢領先 (機會極高)'
      },
      taipei: {
        shortBrief: '蔣萬安維持領先優勢，預估得票率約 59.7% vs 40.3%（差距 19.4%）。9月22日信民協會戴立安發布雙底冊震撼民調，蔣萬安 41.7% vs 沈伯洋 40.5% 呈極限拉鋸，與聯合報系、ETtoday 逾 24% 差距形成顯著機構分歧，模型加權後沈伯洋首破四成。',
        detailedBrief: '台北市選情出現震撼性機構分歧。9月22日台北市信民兩岸研究協會發布由戴立安規劃、畢肯執行之市話手機雙底冊最新調查，蔣萬安以 41.7% 微幅領先沈伯洋 40.5%（差距僅 1.2 個百分點，抽樣誤差 ±3.0%），引發政壇高度震動與攻防質疑。然而此前聯合報系／關鍵調查（蔣 52.6% vs 沈 28.4%）與 ETtoday（蔣 53.8% vs 沈 27.5%）均呈現蔣萬安大幅領先逾兩成。模型在時間自適應衰減與單一機構 35% 權重截斷下，蔣萬安預估得票率由 64.6% 修正至 59.7%，沈伯洋則大幅上修突破四成至 40.3%（差距收窄至 19.4%）。蔣萬安仍掌握勝勢，但選局不再呈單向壓倒。',
        factors: [
          '核心勝負手：中間選民與青年手機族群投票率 vs 藍營傳統鐵票動員',
          '基本盤結構：台北傳統結構藍大於綠，但白營票源與仇恨值流向成變數',
          '機構效應：信民協會(+1.2%藍極限拉鋸) vs 聯合報系(+24.2%藍) 極端分歧'
        ],
        confidence: '優勢領先 (機構顯著分歧)'
      },
      taoyuan: {
