...
const ClearPollModel = {
  ...
  getAIElectionAssessment(electionId, city, context = {}) {
    ...
    const assessments = {
      ...
      kaohsiung: {
        shortBrief: '綠營賴瑞隆維持領先但戰況驟然升溫，預估得票率約 52.0% vs 48.0%（差距 4.0%）。9月18日 ETtoday 最新民調柯志恩 43.8% vs 賴瑞隆 43.5% 首度戰平，藍營展現強烈追擊動能，陳其邁執政紅利與原縣區動員為綠營防線。',
        detailedBrief: '高雄市選情由民進黨參選人賴瑞隆維持微幅優勢，但選局張力顯著升高。9月18日 ETtoday 民調雲最新調查顯示柯志恩 43.8% 與賴瑞隆 43.5% 差距僅 0.3%，雙方首度在科學電話民調中呈現五五波平盤。雖然傳統長期多機構民調中賴瑞隆在原縣區組織與綠營基本盤（約 56:44）佔優，且現任市長陳其邁施政滿意度破七成提供後盾，模型預估賴瑞隆以 52.0% vs 48.0% 保有勝勢，但柯志恩追擊氣勢不可小覷。',
        factors: [
      ...
      taichung: {
        shortBrief: '藍營江啟臣維持雙位數領先，預估得票率約 58.1% vs 41.9%（差距 16.2%）。9月中旬 TVBS 最新民調江啟臣 45.1% 領先何欣純 32.5%，盧秀燕市政光環加持，江啟臣連任接棒勝算極高。',
        detailedBrief: '台中市選情呈現藍營顯著優勢局面。何欣純深耕原台中縣區基層，近期積極合體助選拉抬青年氣勢。然而現任市長盧秀燕長年穩居全台施政滿意度前列，9月中旬國民黨團委託 TVBS 民調江啟臣以 45.1% 領先何欣純 32.5%（差距 12.6 個百分點）。台中近年選民結構雖具搖擺特性，但藍營現任市政光環與地方派系整合完整，模型評估江啟臣勝選機會極高。',
        factors: [
          '核心勝負手：原縣區地方派系與中間搖擺票',
